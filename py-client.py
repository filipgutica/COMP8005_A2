...
def chatSession(hostname, port, message, numOfMessages, logFile):
    totalResponseTime = 0
    dataSent = 0
...
if __name__ == '__main__':
    ...
    for i in range (0, numOfSessions):
        chatThread = threading.Thread(target=chatSession, args=(HOSTNAME, PORT, message, numOfMessages, logFileQueue))
